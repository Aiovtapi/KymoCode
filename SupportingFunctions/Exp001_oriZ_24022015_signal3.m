function initval=Exp001_oriZ_24022015_signal3(initval, user) 
...
%           initval.FLdatapath='Fluorescence/DnaX_YPet_Fluorescence_Aligned/';
    case 'Roy'
        initval.basepath='/Users/rleeuw/Work/Data/20150209_DnaQ_OriZ/80msExp_Acq_2pt5minDnaQ_2pt5minOri1_2pt5minOriZ_003_C1/';
        initval.BFdatapath='Brightfield/';
        initval.FiguresFolder='Figures/';
        initval.FLdatapath='Fluorescence/C3/';
end

initval.BFfiletemplate='BF.tif';
initval.FLfiletemplate='C3_R_I_Corrected.tif';
initval.maxfile=331;
...
initval.nms={'Exp001_DnaN_TUS_dif_30122014_DnaNsignalChan_x224','Exp001_DnaN_TUS_dif_30122014_DnaNsignalChan_x245'};

initval.outname='oriZExp';
initval.outname_usr='oriZExp_UserInputs';
