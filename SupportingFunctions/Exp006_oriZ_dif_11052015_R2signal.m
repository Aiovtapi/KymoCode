function initval=Exp006_oriZ_dif_11052015_R2signal(initval, user) 
...
initval.FLfiletemplate='CFP_RB_IC_TC.tif';
initval.maxfile=428;
...
initval.nms={'Exp006_oriZ_dif_110515_R2signalChan_x266'};
