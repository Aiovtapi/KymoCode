function initval=Exp006_oriZ_dif_11052015_DnaNsignal(initval, user) 
...
%           initval.FLdatapath='Fluorescence/DnaX_YPet_Fluorescence_Aligned/';
    case 'Roy'
        initval.basepath='/Users/rleeuw/Work/Data/20150511_OriZ_dif/Exp6/';
        initval.BFdatapath='Brightfield/';
        initval.FiguresFolder='Figures/';
...
initval.FLfiletemplate='YFP_RB_IC_TC.tif';
initval.maxfile=428;
...
initval.nms={'Exp006_oriZ_dif_110515_DnaNsignalChan_x261'};
