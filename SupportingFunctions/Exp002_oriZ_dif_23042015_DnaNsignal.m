function initval=Exp002_oriZ_dif_23042015_DnaNsignal(initval, user) 
...
%           initval.FLdatapath='Fluorescence/DnaX_YPet_Fluorescence_Aligned/';
    case 'Roy'
        initval.basepath='/Users/rleeuw/Work/Data/OriZ_Dif_2304/002/YFP/';
        initval.BFdatapath='Brightfield_Processed/';
        initval.FiguresFolder='Figures/';
        initval.FLdatapath='Fluorescence_RB_IC_AC_stack/';
...
initval.FLfiletemplate='YFP.tif';
initval.maxfile=414;
...
initval.nms={'Exp002_oriZ_dif_2304_DnaNsignalChan_x304'};
...
%used for clicking-------------------------------------
initval.zoom=200;
initval.estimateddoublingtime=100; %in frames   
