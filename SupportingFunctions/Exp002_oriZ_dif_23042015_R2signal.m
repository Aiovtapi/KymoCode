function initval=Exp002_oriZ_dif_23042015_R2signal(initval, user) 
...
%           initval.FLdatapath='Fluorescence/DnaX_YPet_Fluorescence_Aligned/';
    case 'Roy'
        initval.basepath='/Users/rleeuw/Work/Data/OriZ_Dif_2304/002/CFP/';
        initval.BFdatapath='Brightfield_Processed/';
        initval.FiguresFolder='Figures/';
        initval.FLdatapath='Fluorescence_RB_IC_AC/';
...
initval.FLfiletemplate='CFP.tif';
initval.maxfile=414;
...
initval.nms={'Exp002_oriZ_dif_2304_R2signalChan_x304'};
