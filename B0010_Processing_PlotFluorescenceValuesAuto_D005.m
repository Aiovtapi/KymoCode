...
peak_labels=Convert_fluorescence_to_labelcounts_D005(countsperlabel,peak_labels,abs_frames);
all_labels=Convert_fluorescence_to_labelcounts_D005(countsperlabel,all_labels_raw,abs_frames);
