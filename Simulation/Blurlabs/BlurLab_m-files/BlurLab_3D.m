function varargout = BlurLab_3D(varargin)
%
% For instructions, launch BlurLab and select the 'Help' button.
%
% The following m-files should be included with 'BlurLab_3D.m' and
% 'BlurLab_3D.fig':
%
% custom_noise.m
% helppopup.m
...
% Last Modified by GUIDE v2.5 12-Aug-2011 01:39:19
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @BlurLab_3D_OpeningFcn, ...
    'gui_OutputFcn',  @BlurLab_3D_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before BlurLab_3D is made visible.
function BlurLab_3D_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = BlurLab_3D_OutputFcn(hObject, eventdata, handles)
