...
elseif handles.TDDC_radioDC3.Value == 1;
    ...
    ini.DCY(:,2) = TDDC_createvec(handles.plotx1,handles.ploty1,nframes)'/100;
    ini.DCY(:,3) = TDDC_createvec(handles.plotx2,handles.ploty2,nframes)'/100;
...
% --- Executes during object creation, after setting all properties.
function TDDC_edit_DC1_CreateFcn(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function TDDC_edit_DC2_CreateFcn(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function TDDC_edit_DC3_CreateFcn(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function TDDC_slider_L2_CreateFcn(hObject, eventdata, handles)
