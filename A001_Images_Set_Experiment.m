...
%common settings---------------------------------------------
if nargin<1, exp='002_DnaN_TUS_dif_21112014_DnaNsignal';end
user='Roy';
switch user
      case 'Jacob', 
      ...
      case 'Roy' ,
          ...
          versionpath='201412_TUSdifDnaN_Montage/';
          toolspath='SupportingFunctions';
          initval.skippicturesavingbecauseCharlislogginghislive=0;
end
...
switch exp    
    case   '002_DnaN_TUS_dif_21112014_DnaNsignal',            initval=Exp002_DnaN_TUS_dif_21122014_DnaNsignal(initval, user);
    case   '002_DnaN_TUS_dif_21112014_TUSsignal',             initval=Exp002_DnaN_TUS_dif_21112014_TUSsignal(initval, user);
end
