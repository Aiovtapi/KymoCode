...
NoiseFolder='1500-225';

TestFile=NoiseFolder;
...
Tsize=size(data,3); XSize=zeros(size(data,2),1);
...
%     [ydatacrpd{i},~]=Crop_Image(ydata{i});
    ...
    while x0{j}(i,1)>IntensityPeakThreshold
...
%% Save results
  save(strcat('/Users/rleeuw/Work/DataAnalysis/BlurLab/',TestFolder,'/',NoiseFolder,'/',TestFile),'x','XNorm','NSpots','SNR','ydatacrpd');
end
toc