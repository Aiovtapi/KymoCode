    ...
    for flchan = 1:FLchans
        ...
        for cell=1:Ncells
            ...
            while imgflip == 1; 
                ...
                thisbacfolder=strcat('cell',num2str(cell,'%03.0f'));
                ...
                if ~strcmp(viewFLchans{flchan},initval.difchan)
                    if exist(strcat(Resultsfolder,initval.OSslash,'Results_Ch',num2str(mdchan),'.mat'),'file')
                        ...
                        imgflipped = DataStruct(1,cell).imgflipped;
                        if imgflipped==1
...
%                 end
                ...
                DataStruct(flchan,cell).x = x;
                DataStruct(flchan,cell).XNorm = XNorm;
                DataStruct(flchan.cell).NSpots = NSpots;
                DataStruct(flchan,cell).ydatacrpdR1 = ydatacrpdR1;
                DataStruct(flchan,cell).pixels = pixels;
                DataStruct(flchan,cell).imgflipped = imgflipped;
